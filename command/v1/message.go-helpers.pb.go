...
// Marshal an object of type AppendStreamRecordsCommandAttributes to the protobuf v3 wire format
func (val *AppendStreamRecordsCommandAttributes) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type AppendStreamRecordsCommandAttributes from the protobuf v3 wire format
func (val *AppendStreamRecordsCommandAttributes) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *AppendStreamRecordsCommandAttributes) Size() int {
	return proto.Size(val)
}

// Equal returns whether two AppendStreamRecordsCommandAttributes values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *AppendStreamRecordsCommandAttributes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *AppendStreamRecordsCommandAttributes
	switch t := that.(type) {
	case *AppendStreamRecordsCommandAttributes:
		that1 = t
	case AppendStreamRecordsCommandAttributes:
		that1 = &t
	default:
...
// Marshal an object of type SubscribeStreamCommandAttributes to the protobuf v3 wire format
func (val *SubscribeStreamCommandAttributes) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type SubscribeStreamCommandAttributes from the protobuf v3 wire format
func (val *SubscribeStreamCommandAttributes) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *SubscribeStreamCommandAttributes) Size() int {
	return proto.Size(val)
}

// Equal returns whether two SubscribeStreamCommandAttributes values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *SubscribeStreamCommandAttributes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *SubscribeStreamCommandAttributes
	switch t := that.(type) {
	case *SubscribeStreamCommandAttributes:
		that1 = t
	case SubscribeStreamCommandAttributes:
		that1 = &t
	default:
