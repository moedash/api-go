...
// Marshal an object of type WorkflowStreamSubscribedEventAttributes to the protobuf v3 wire format
func (val *WorkflowStreamSubscribedEventAttributes) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type WorkflowStreamSubscribedEventAttributes from the protobuf v3 wire format
func (val *WorkflowStreamSubscribedEventAttributes) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *WorkflowStreamSubscribedEventAttributes) Size() int {
	return proto.Size(val)
}

// Equal returns whether two WorkflowStreamSubscribedEventAttributes values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *WorkflowStreamSubscribedEventAttributes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *WorkflowStreamSubscribedEventAttributes
	switch t := that.(type) {
	case *WorkflowStreamSubscribedEventAttributes:
		that1 = t
	case WorkflowStreamSubscribedEventAttributes:
		that1 = &t
	default:
